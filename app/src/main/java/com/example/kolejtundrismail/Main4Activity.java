...
//        //mStatusText.setText("Congratulation!! You have been registered successfully!!!");
...
//        setContentView(activityLayout);
    ...
    private void refreshResults() {
        if (credential.getSelectedAccountName() == null) {
            ...
            if (isDeviceOnline()) {
//                Log.d("CREATION", "device on");
                String name = getIntent().getStringExtra("name");
                String place = getIntent().getStringExtra("place");
                String date = getIntent().getStringExtra("date");
                String merit = getIntent().getStringExtra("merit");
//                Log.d("CREATION", this.name);
                new ApiAsyncTask(this, name,place,date,merit).execute();
                //Log.d("CREATION", this.);
            } else {
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                if (dataStrings == null) {
                    ...
                    Toast.makeText(getApplicationContext(),"You have been registered this Activity successfully",Toast.LENGTH_SHORT).show();
                    //mResultsText.setText("You calendar have been updated to this link below \n"+new Intent(Intent.ACTION_VIEW, (Uri) dataStrings));
                }
            }
        });
    }
